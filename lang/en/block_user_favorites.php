...
// Buttons.
$string['btn:delete'] = 'Delete bookmark';
$string['btn:remove'] = 'Delete bookmark';
$string['btn:add'] = 'Bookmark this page';
$string['btn:edit'] = 'Edit bookmark';

// Js.
$string['javascript:yes'] = 'Save';
$string['javascript:no'] = 'Cancel';
$string['javascript:set_title'] = 'Set title of the bookmark';
